...
const PortfolioOverlayData = [
  {
    ...
    category: ["Power BI"],
    subtitle: "Power BI interactive dashboard",
  ...
  },
  {
    ...
    img: "https://via.placeholder.com/800x800",
    category: ["Power BI"],
    subtitle: "Management reporting for leadership",
  ...
  },
  {
    ...
    subtitle: "Predictive analytics and segmentation",
  ...
  },
  {
    ...
    img: "https://via.placeholder.com/800x800",
    category: ["Tableau"],
    subtitle: "Interactive financial storytelling",
    link: "/portfolio/single-project-page-04"
  },
  {
    title: "BC Central analytics",
    img: "https://via.placeholder.com/800x800",
    category: ["BC Central"],
    subtitle: "ERP reporting and insights",
    link: "/portfolio/single-project-page-05"
  },
  {
    title: "Dynamics Navision insights",
    img: "https://via.placeholder.com/800x800",
    category: ["Dynamics Navision"],
  ...
  },
  {
    ...
    subtitle: "Themes and narrative insights",
    link: "/portfolio/single-project-page-02"
  },
  {
    ...
    subtitle: "Statistical analysis and reporting",
    link: "/portfolio/single-project-page-03"
  }
]
                      ...
                      <ReactCustomScrollbar className="h-full flex justify-center" autoHide>
                        <div>
                          <ul className="font-serif w-full flex flex-col justify-center h-full">
                            <li className="py-[13px] px-0 relative sm:text-center xs:!py-[10px]">
                              <Link className="!font-normal" aria-label="link for" to="/">
                                home
                              </Link>
                            </li>
                            <li className="py-[13px] px-0 relative sm:text-center xs:!py-[10px]">
                              <Link className="!font-normal" aria-label="link for" to="/page/about-me">
                                about
                              </Link>
                            </li>
                            <li className="py-[13px] px-0 relative sm:text-center xs:!py-[10px]">
                              <Link className="!font-normal" aria-label="link for" to="/page/our-services">
                                services
                              </Link>
                            </li>
                            <li className="py-[13px] px-0 relative sm:text-center xs:!py-[10px]">
                              <Link className="!font-normal" aria-label="link for" to="/portfolio/portfolio-colorful-metro">
                                portfolio
                              </Link>
                            </li>
                            <li className="py-[13px] px-0 relative sm:text-center xs:!py-[10px]">
                              <Link className="!font-normal" aria-label="link for" to="/page/contact-modern">
                                contact
                              </Link>
                            </li>
                          </ul>
        ...
        <Container>
          <Row className=" align-center">
            <m.div className="col-lg-5 text-darkgray md:mb-[30px] text-left" {...fadeIn}>
              <h2 className="heading-6 font-serif leading-[40px] w-[90%] mb-0 lg:w-full sm:leading-[26px] xs:text-center">
                A Senior Data Analyst with 5 years of experience in data analytics,
                data modelling, dashboard development and business intelligence
                solutions.
              </h2>
            </m.div>
            <Col xl={{ span: 6, offset: 1 }} lg={7} md={9} className="flex items-center xs:flex-col">
              <m.div className="w-[60%] md:w-[55%] xs:w-full xs:mb-[15px]" {...{ ...fadeInLeft, transition: { delay: 0.4, duration: 0.4 } }}>
                <span className="font-serif text-[11rem] leading-[11rem] text-darkgray font-semibold -tracking-[7px] block xs:text-center md:text-[9rem]"><span className="text-[#ffeb04] font-light mr-[35px]">|</span>5<span className="text-[#ffeb04] font-light ml-[35px]">|</span></span>
              </m.div>
              <m.div className="text- w-[40%] pl-[25px] xs:w-full md:pl-0"  {...{ ...fadeInLeft, transition: { delay: 0.6, duration: 0.6 } }}>
                <h3 className="heading-5 font-serif font-medium text-darkgray mb-0 -tracking-[1px] xs:text-center">Years of data analytics experience</h3>
              </m.div>
            </Col>
          </Row>
        </Container>
          ...
          <m.div className="row" {...{ ...fadeIn, transition: { delay: 0.4 } }}>
            <Col className="col-lg-5 md:mb-20 sm:mb-16">
              <h2 className="heading-6 font-serif text-darkgray mb-0 leading-[40px] sm:leading-[26px]">
                Providing <span className="font-semibold">high-quality data analytics and business intelligence solutions</span> including
                Power BI, Tableau, BC Central, Dynamics Navision and Power BI service configurations.
              </h2>
            </Col>
          ...
          <Row>
            <Col lg={4} className="justify-start md:justify-center md:mb-[20px] flex items-center">
              <span className="font-serif font-semibold text-sm uppercase text-darkgray">
                Senior Data Analyst · Data analytics · Business intelligence
              </span>
            </Col>
            ...
            <Col lg={4} className="text-right justify-end md:justify-center md:text-center flex items-center">
              <p className="font-serif font-semibold text-sm uppercase text-darkgray leading-[30px]">
                © {new Date().getFullYear()} Victor Munene. All rights reserved.
              </p>
            </Col>
          </Row>
        </Container>
